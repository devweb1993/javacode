...
public class GE9x {
    ...
    public final double takeoffThrust = 1_00_000;
    ...
    public double calculateHoursNeeded(){
    	return flightHoursBeforeRebuild;
    }
    public double calculateLeftServiceHours(){
        return flightHours -(maxNumRebuilds-numRebuilds);	
      }
}
